...
import {
    CircleSegmentBar as CircleSegmentBarModule,
...
export class CircleSegmentBar extends CircleSegmentBarModule {
    ...
    public createNativeView() {
        return this._nativeView = new com.natasa.progressviews.CircleSegmentBar(this._context);
    }
